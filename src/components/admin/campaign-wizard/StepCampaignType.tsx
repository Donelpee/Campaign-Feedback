...
const campaignTypes: {
...
}[] = [
  {
    ...
    description:
      "NPS, satisfaction ratings, and service quality surveys for clients",
    icon: MessageSquare,
  },
  {
    ...
    description:
      "Internal staff engagement, satisfaction, and feedback collection",
    icon: Users,
  },
  {
    ...
    description:
      "Market research, product feedback, and feature prioritization",
    icon: Package,
  },
  {
    ...
    description:
      "Post-event feedback, session ratings, and attendee satisfaction",
    icon: CalendarCheck,
  },
];
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">
        Select the type of campaign you want to create. This will help us
